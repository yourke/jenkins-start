...
# xjar-agent-hibernate是为了解决Hibernate的解密问题，默认该jar在上级目录下
echo " > 执行启动命令：nohup java -javaagent:../xjar-agent-hibernate-v1.0.0.jar -jar -Xmx1g -Xms1g ${package_path} ${params} >/dev/null 2>&1 &"
nohup java -javaagent:../xjar-agent-hibernate-v1.0.0.jar -jar -Xmx1g -Xms1g ${package_path} ${params} >/dev/null 2>&1 &
echo " > 启动命令执行完成！"
